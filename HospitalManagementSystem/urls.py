...
urlpatterns = [
    ...
    path('update_patient_record', update_patient_record, name='update_patient_record'),
    ...
    path('add_procedure', add_procedure, name='add_procedure'),
    path('view_procedure', view_procedure, name='view_procedure'),
    path('delete_procedure/<int:pid>', Delete_procedure, name='delete_procedure'),
